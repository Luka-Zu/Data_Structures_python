import ctypes
# this library provides C compatible data types, and allows calling functions in DLLs or shared libraries.
...
class DynamicArray:
    ...
    def make_array(self, new_capacity):
        """
            Creates new array with different capacity
            It is done in O(N)
        """
    ...
    def delete(self):
        ...
        # in reality this is not even necessary as we change n to n-1 and cant access this index at all
